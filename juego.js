...
function intercambiarPosiciones(filaPos1, columnaPos1, filaPos2, columnaPos2){
    ...
    var clonPieza5 = pieza5.cloneNode(true);

    var pieza9 = document.getElementById("pieza-9");
    var clonPieza9 = pieza9.cloneNode(true);

    var padre5 = pieza5.parentNode;
    var padre9 = pieza9.parentNode;

    padre5.replaceChild(clonPieza5, pieza9);
    padre9.replaceChild(clonPieza9, pieza5);
